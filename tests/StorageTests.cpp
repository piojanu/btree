...
struct StorageBasicTest : public ::testing::Test {
    StorageBasicTest() : values{1, 1, 2, 2, 0, 0, 0, 0, 0, 0,
                                2, 1, 1, 2, 2, 0, 0, 0, 0, 0,
                                3, 3, 3, 4, 4, 5, 5, 0, 0, 0}, height(2),
    ...
    uint64_t values[30], nodes_count = sizeof(values) / sizeof(btree::Node<RECORDS_IN_INDEX_NODE>), height;
...
TEST_F(StorageBasicTest, GIVENstorageWithNodesWHENfindNodeKey2THENproperlyOpenedNodePath) {
    ...
    EXPECT_EQ(0, node[0].node.next_offset);

    EXPECT_EQ(1, node[1].offset);
    EXPECT_EQ(1, node[1].index);
    EXPECT_EQ(values[10], node[1].node.usage);
    EXPECT_EQ(values[10 + 1], node[1].node.node_entries[0].offset);
    EXPECT_EQ(values[10 + 2], node[1].node.node_entries[0].record.key);
    EXPECT_EQ(values[10 + 3], node[1].node.node_entries[1].offset);
    EXPECT_EQ(values[10 + 4], node[1].node.node_entries[1].record.key);
    EXPECT_EQ(values[10 + 5], node[1].node.node_entries[2].offset);
    EXPECT_EQ(values[10 + 6], node[1].node.node_entries[2].record.key);
    EXPECT_EQ(values[10 + 7], node[1].node.node_entries[3].offset);
    EXPECT_EQ(values[10 + 8], node[1].node.node_entries[3].record.key);
    EXPECT_EQ(0, node[1].node.next_offset);
}
...
TEST_F(StorageBasicTest, GIVENstorageWithNodesWHENfindNodeKey5THENproperlyOpenedNodePath) {
    ...
    EXPECT_EQ(values[20], node[1].node.usage);
    EXPECT_EQ(values[20 + 1], node[1].node.node_entries[0].offset);
    EXPECT_EQ(values[20 + 2], node[1].node.node_entries[0].record.key);
    EXPECT_EQ(values[20 + 3], node[1].node.node_entries[1].offset);
    EXPECT_EQ(values[20 + 4], node[1].node.node_entries[1].record.key);
    EXPECT_EQ(values[20 + 5], node[1].node.node_entries[2].offset);
    EXPECT_EQ(values[20 + 6], node[1].node.node_entries[2].record.key);
    EXPECT_EQ(values[20 + 7], node[1].node.node_entries[3].offset);
    EXPECT_EQ(values[20 + 8], node[1].node.node_entries[3].record.key);
    EXPECT_EQ(0, node[1].node.next_offset);
}
...
TEST_F(StorageBasicTest, GIVENstorageWithNodesWHENopenNodeTHENproperlyOpenedNode) {
    ...
    EXPECT_EQ(values[10], node.usage);
    EXPECT_EQ(values[10 + 1], node.node_entries[0].offset);
    EXPECT_EQ(values[10 + 2], node.node_entries[0].record.key);
    EXPECT_EQ(values[10 + 3], node.node_entries[1].offset);
    EXPECT_EQ(values[10 + 4], node.node_entries[1].record.key);
    EXPECT_EQ(values[10 + 5], node.node_entries[2].offset);
    EXPECT_EQ(values[10 + 6], node.node_entries[2].record.key);
    EXPECT_EQ(values[10 + 7], node.node_entries[3].offset);
    EXPECT_EQ(values[10 + 8], node.node_entries[3].record.key);
    EXPECT_EQ(0, node.next_offset);
